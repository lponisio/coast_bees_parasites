...
setwd("C:/Users/mycol/Dropbox (University of Oregon)/coast_bees_parasites")
...
#REMINDER to remove orig.spec and reload it from 1_sems with weights
#before continuing
